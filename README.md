...
- Перебирались методы масштабирования количественных признаков (StandardScaler, MinMaxScaler, RobustScaler).
- Сравнивались 4 модели классификации: KNeighborsClassifier, DecisionTreeClassifier, LogisticRegression и SVC, для каждой из которых перебирались гиперпараметры.

### <u>Результаты:</u>**
Лучшей моделью оказалась логистическая регрессия со следующими параметрами:
- Обработка количественных признаков с помощью MinMaxScaler
